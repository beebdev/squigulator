...
- `--ont-friendly=yes/no`:   generate fake uuid for readids and add a dummy end_reason (from v0.5.0 dummy end_reason is always added, regardless of this option).  [default: no]
